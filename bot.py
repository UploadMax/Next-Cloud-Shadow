...
save_cred = {"carmen.gomez":{"ID":None,"TOKEN":"oeqTZPpmnNnb7KH"},"fenix.invitado2021@gmail.com":{"ID":"fenix.invitado2021%40gmail.com","TOKEN":"EqLNoqgceoixn6M"},"susej.mabel2009@gmail.com":{"ID":None,"TOKEN":"64y9HKakm9swzXg"},"dailenys.fonseca":{"ID":None,"TOKEN":"64y9HKakm9swzXg"},"daniel.ramirezd":{"ID":None,"TOKEN":"fgBrHtogiisjGwz"},"leander.martinez":{"ID":None,"TOKEN":"WWXnQaWf9csckes"},"carmen.gomez":{"ID":None,"TOKEN":"zrGWiQWRRRsYt6w"},"esther.guardia":{"ID":None,"TOKEN":"WD3QkibRBJ78Bb4"},"victor.araujo":{"ID":None,"TOKEN":"ENCqEGYLCs6GMKw"},"humberto.rodriguezl":{"ID":None,"TOKEN":"DLcqbmyjkcy73c4"},"leudys.zamora":{"ID":None,"TOKEN":"PQ47k2aSJRpA2QY"},"marcos.calero":{"ID":None,"TOKEN":"GwRkbMCGSs8tYLz"},"jose.pelierr":{"ID":None,"TOKEN":"BMjYn45Pzi2ijZE"},"roxana.vilasanchez":{"ID":None,"TOKEN":"RM5R9QEm4GAXGG9"}}
control_upload = {}
bytes_control = {}
...
async def config(client: Client, message: Message):	
	...
	if host=="https://eva.uo.edu.cu/" or host=="https://eva.uo.edu.cu":
		Configs[username]["m"] = "eva"
	await send_config()
...
async def up(client: Client, message: Message):	
	...
	try:
		...
		elif Configs[username]["m"] == "eva":
			await msg.edit("Eva Client Upload ...")
...
async def webdav(filex,user_id,msg,username):
	...
	send = msg.reply
	proxy = Configs[username]["gp"]
	user = "carmen.gomez" #Config[username]["username"]
	password = "UploadFree1234*" #Config[username]["password"]
	host = Config[username]["host"]
	zips = Configs[username]["z"]
